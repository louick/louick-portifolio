...
const processes: Process[] = [
	{
		...
		steps: [
			'Definição de objetivos, público e escopo',
			'Mapeamento de jornadas do usuário e arquitetura de informação',
			'Protótipo navegável e validação de interface (Figma)',
		],
	},
	{
		...
		steps: [
			'Setup com Next.js, React, Flutter e APIs REST/GraphQL',
			'Integração de backend com Node.js, Ruby e MongoDB',
			'Testes automatizados, revisão contínua e deploy incremental',
		],
	},
	{
		title: 'Lançamento & Escalabilidade',
		colorClasses: {
			bg: 'bg-green-500/10',
			text: 'text-green-400',
		...
		steps: [
			'Publicação em lojas (Play Store e Web)',
			'Monitoramento com analytics e logs de erro',
			'Otimizações, atualizações frequentes e novos módulos',
		],
	},
];
	...
	return (
		<section className="py-16 md:py-20 relative">
			<div className="container mx-auto px-4">
				<h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-center">Processo de Desenvolvimento</h2>
				<p className="text-sm sm:text-base text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
					Fluxo técnico utilizado para criar aplicações modernas, escaláveis e com foco em usabilidade.
				</p>
							...
							<div key={index} className="group relative">
								...
								>
									<div className="mb-6">
										...
										<h3 className={`text-xl font-semibold mb-3 text-center group-hover:${process.colorClasses.text} transition-colors`}>
											{process.title}
										</h3>
									</div>
