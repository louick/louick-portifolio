...
const apps: App[] = [
  {
    id: 1,
    name: 'Fortalezinha App',
    description:
      'Guia turístico com hospedagens, transporte e gastronomia local — feito com Flutter + Next.js',
    technologies: ['Flutter', 'Next.js', 'Node.js'],
  ...
  },
  {
    ...
    name: 'BrideView',
    description:
      'Plataforma para eventos onde convidados compartilham fotos em tempo real',
    technologies: ['React', 'MongoDB', 'Ruby'],
    platforms: ['Web'],
    downloads: '200K+',
    rating: 4.8,
  },
            ...
            >
              <div className="bg-gradient-to-b from-gray-900 to-gray-800 rounded-xl sm:rounded-2xl overflow-hidden p-4 sm:p-6 relative">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                  <div className="w-16 sm:w-20 h-16 sm:h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-500 p-1 flex-shrink-0 relative">
                    <div className="w-full h-full rounded-xl bg-gray-900 flex items-center justify-center overflow-hidden">
                      <svg
                        className={`w-10 h-10 ${app.id === 1 ? 'text-blue-400' : 'text-purple-400'}`}
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      >
                        {app.id === 1 ? (
                          ...
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M12 4a8 8 0 110 16 8 8 0 010-16zm0 8.5l2.5-2.5M12 12.5L9.5 10M12 13v3"
                          />
                        )}
                      </svg>
